      ...
      <Tab.Content className="tab-content">
        ...
        >
          <div className="jm-register-tab-content-inner">
            ...
            <Link to="/employerSignUp" className="jm-register-btn">Register as Employer</Link>
          </div>
        </Tab.Pane>
        <Tab.Pane
          eventKey="register-1"
        ...
        >
          <div className="jm-register-tab-content-inner">
            ...
            <Link to="/candidateSignUp" className="jm-register-btn">Register as Candidate</Link>
          </div>
        </Tab.Pane>
      </Tab.Content>
    </div>
